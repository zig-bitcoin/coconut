...
pub fn runServer(
    ...
    router.post("/v1/melt/quote/bolt11", routes.default.meltQuoteBolt11);
    ...
    router.get("/v1/melt/quote/bolt11/:quote_id", routes.default.getMeltQuoteBolt11);
    router.post("/v1/melt/bolt11", routes.default.meltBolt11);
